...
/// Where Notch shows itself, apart from the notch.
///
...
enum AppPresence: String, CaseIterable, Identifiable {
    ...
    var explanation: String {
        switch self {
        case .dock:
            return "A normal app icon in the Dock while Notch is running."
        case .menuBar:
        ...
        case .hidden:
            ...
            return "No icon anywhere. Open Notch again from Applications to "
