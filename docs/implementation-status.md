...
- Native tests, Windows installer lifecycle and Mac development DMG passed for `dd8d809` in [candidate run 34515435708](https://github.com/moha-b/Notch/actions/runs/34515435708). This includes the credential-hardening batch; it does not include the local Gemini changes described below.
